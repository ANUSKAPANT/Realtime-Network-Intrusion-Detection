...
channel = "##ioe-bot-channel" # Channel
...
botnick = "IamaIoeBot-2" # Your bots nick.
...
adminname = "IoeBotAdmin" #Your IRC nickname. I go by OrderChaos on IRC (and most other places) so that is what I'm using for this example.
...
ircsock.connect((server, 9999)) # Here we connect to the server using the port 6667
